...
import com.beework.auth.filtri.JwtRequestFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(DettagliUtenteService dettagliUtenteService) {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(dettagliUtenteService).passwordEncoder(getPasswordEncoder());
    }
